/**
  ******************************************************************************
  * @file    VoiceRecognitionV4.h
  * @author  Elechouse Team (V4 by John Wasser)
  * @version V4.0
  * @date    2021-10-2
  ...
  * @section  HISTORY
    ...
    V4.0    Modified to take Stream pointers (Serial1, Serial2, SoftwareSerial...)
                Usage:
        ...
        void setup(void)
        {
            Serial1.begin(38400); // Default baud rate for VoiceRecognitionV3 module
            Serial2.begin(38400); // Default baud rate for VoiceRecognitionV3 module
...
/***************************************************************************/
    ...
    int read() {return streamPtr->read();}
    void write(byte b) {streamPtr->write(b);}
    void write(const uint8_t *buf, const uint8_t len) {streamPtr->write(buf, len);}
    int available() {return streamPtr->available();}
};